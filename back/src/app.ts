...
//
// const allowedOrigins = ['http://localhost:3000', 'https://kdt-ai-8-team02.elicecoding.com/api'];
// // app.use(cors());
//
// app.use(cors({
//   origin: allowedOrigins, // Replace with the origins you want to allow
...
const allowedOrigins = ['http://localhost:3000', 'https://kdt-ai-8-team02.elicecoding.com'];
